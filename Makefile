...
help:
	...
	@echo "  test-medium-resp-integreation-request-mgr - Run medium responses integration tests with Request Manager (5 conversations)"
...
.PHONY: test-medium-resp-integreation-request-mgr
test-medium-resp-integreation-request-mgr:
	@echo "Running medium responses integration test with Request Manager..."
	uv --directory evaluations run evaluate.py -n 5 --test-script chat-responses-request-mgr.py --reset-conversation --timeout=1800 $(VALIDATE_LAPTOP_DETAILS_FLAG) $(STRUCTURED_OUTPUT_FLAG)
